...
//This is run by passing a command line argument to this program.
//See: https://dailydotnettips.com/how-to-pass-command-line-arguments-using-visual-studio/
//To sum: Project>>Properties>>Debugging>>Command Arguments
int main(int argc, char* argv[])
{
	if (argc != 2) {
		std::cout << "Usage: TravelSimulator <debug_level>" << std::endl;
		return -1;//non-zero indicates an error condition
	}
	LVL = atoi(argv[1]);
