...
int main()
{
...
#ifdef DEBUG
	Log(Log_Lvl::LOG_INFO, "Created the objects");
#endif
	...
	while (isRunning) {
		...
		car4->addFuel(50.0);
#ifdef DEBUG
		Log(Log_Lvl::LOG_INFO, "Added the fuel");
#endif
...
#ifdef DEBUG
		Log(Log_Lvl::LOG_INFO, "Set the efficiency");
#endif
		...
		car4->addFuel(50.0);
#ifdef DEBUG
		Log(Log_Lvl::LOG_INFO, "Added the fuel again");
#endif
...
#ifdef DEBUG
		Log(Log_Lvl::LOG_INFO, "Drove the cars");
#endif
		track = (track + 1) % 5 + 1;
		Sleep(1000);
	}
	...
	car4->displayReport();
#ifdef DEBUG
	Log(Log_Lvl::LOG_INFO, "Displayed the report");
#endif
	...
	delete(car4);
#ifdef DEBUG
	Log(Log_Lvl::LOG_INFO, "Deleted the objects");
#endif
